package com.ashishdake.dialogsearch;
...
import com.ashishdake.dialogsearch.Holder.DialogHolder;
...
import com.ashishdake.dialogsearch.Utils.UtilsDialog;
...
public class SearchDialog implements View.OnClickListener {
    ...
    public SearchDialog(Activity mActivity) {
    ...
    public SearchDialog setActivity(Activity mActivity){
        this.mActivity = mActivity;
        this.alertDialogBuilder = UtilsDialog.createAlertDialog(mActivity);
        backPressedEnabled(true);
        return this;
    ...
    public SearchDialog setOnCloseListener(View.OnClickListener listener){
